                ...
                <div class="row gy-5 g-xl-10">
                    ...
                    <div class="col-xl-12">
                        ...
                        <div class="px-4 py-4 table-main-title">
                            <h2 class="text-white mb-0"><i class="la la-globe fs-2 pe-2 text-white"></i>{!!$page->title_en!!}</h2>
                        </div>
                                            ...
                                            <div id="kt_datatable_example_wrapper" class="dataTables_wrapper dt-bootstrap4 no-footer"><div class="table-responsive">
                                                <table class="table align-middle table-striped table-row-bordered border gy-3 gs-7" id="kt_datatable_example">
                                                    ...
                                                    <tbody class="fw-semibold text-gray-600">
                                                        ...
                                                        <tr class="odd @if($page->slug == 'home') d-none @endif" >
                                                            <td><b>Banner</b></td>
                                                            <td>{!! $page->title_en !!}</td>
                                                            ...
                                                            <td >
                                                                ...
                                                                <form method="POST" action="{{ route('pages.destroy', $page->id) }}" onsubmit="return confirm('Are you sure you want to delete this page?')">
                                                                    @csrf
                                                                    @method('DELETE')
                                                        ...
                                                        @if(count($subpages)>0)
                                                        <tr>
                                                            <td colspan="7" class="text-center bg-primary py-2"><h3 class="text-white mb-0">Sections</h3></td>
                                                        </tr>
